(function(){
  ...
  var b=fb('手首R'); if(!b) return 'no-bone:'+'手首R';
  b.updateWorldMatrix(true,false);
  var p=new THREE.Vector3().setFromMatrixPosition(b.matrixWorld);
  CAM3.target.copy(p); CAM3.dist=0.26; CAM3.yaw=-0.55; CAM3.pitch=0.1;
  return '手首R'+' @ '+p.toArray().map(function(v){return +v.toFixed(3);}).join(',');
})()