( function () {
   ...
   */
		...
		assignTexture( materialParams, mapName, mapDef ) {
			...
			// Afterglow patch: use UV set 0 silently (the loader already does)
			// instead of spamming the console for files (e.g. Chun-Li) that
			// tag every texture with texCoord 1.
